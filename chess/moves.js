  ...
  if (phase === 1) {
    ...
    if (document.getElementById(square).innerHTML === "White Rook") {
        for (mr1 = 1; ((parseInt(square.replace("_", ""))) + mr1) % 8 != "0" && document.getElementById("_" + (parseInt(square.replace("_", "")) + mr1) + "_").innerHTML == ""; mr1 += 1) {
          ...
          rookmove = 1
        } for (mr3 = 8; (parseInt(square.replace("_", "")) + mr3) - ((parseInt(square.replace("_", "")) + mr3) % 8) / 8 != "7" && document.getElementById("_" + (parseInt(square.replace("_", "")) + mr3) + "_").innerHTML == ""; mr3 += 8) {
          document.getElementById("_" + (parseInt(square.replace("_", "")) + mr3) + "_").style.backgroundColor = "#FFF370"
          rookmove = 1
        } for (mr4 = -8; (parseInt(square.replace("_", "")) + mr4) - ((parseInt(square.replace("_", "")) + mr4) % 8) / 8 != "0" && document.getElementById("_" + (parseInt(square.replace("_", "")) + mr4) + "_").innerHTML == ""; mr4 += -8) {
