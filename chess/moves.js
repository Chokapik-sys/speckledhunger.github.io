...
function move_piece(){
  ...
  if (document.getElementById(square).innerHTML === "White Rook") {
    ...
    if (document.getElementById(square).innerHTML === "White Bishop") {
        for (mb1 = 9; (parseInt(square.replace("_", "")) + mb1 - 9) % 8 != "0", (parseInt(square.replace("_", "")) + mb1 + 9) % 8 != "1", document.getElementById("_" + (parseInt(square.replace("_", "")) + mb1) + "_").innerHTML == ""; mb1 += 9) {
