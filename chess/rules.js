...
function king() {
  ...
  if (document.getElementById("_" + wk + "_").innerHTML === "White King") {
    ...
    if ((document.getElementById("_" + (wk - 26) + "_").innerHTML === "Black Knight" && (wk - 26) % 8 != "0" && (wk - 26) > 0) || (document.getElementById("_" + (wk - 19) + "_").innerHTML === "Black Knight" && (wk - 19) % 8 != "0" && (wk - 19) > 0)) {
    KN_NW_whitecheck = 1
    } if ((document.getElementById("_" + (wk - 26) + "_").innerHTML !== "Black Knight" && (wk - 26) % 8 != "0" && (wk - 26) > 0) || (document.getElementById("_" + (wk - 19) + "_").innerHTML !== "Black Knight" && (wk - 19) % 8 != "0" && (wk - 19) > 0)) {
    KN_NW_whitecheck = 0
    }
